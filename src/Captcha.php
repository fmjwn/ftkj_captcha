...
namespace ftkj\common;


use think\facade\Cache;
use think\facade\Env;

/** 前后端分离的tp验证码，依赖于think-captcha 库。
 * Class FtCaptcha
 * @package app\common
 */
class FtCaptcha
{
    ...
    const CACHE_FT_CAPTCHA_PREFIX = 'cache_ft_captcha_';
    ...
    public function check($code, $id)
    {
        ...
        $secode = Cache::get(self::CACHE_FT_CAPTCHA_PREFIX.$id);
...
//        }
        ...
        if ($this->authcode(strtoupper($code)) == $secode) {
            Cache::rm(self::CACHE_FT_CAPTCHA_PREFIX.$id);
    ...
    public function entry()
    {
        ...
        //$ttfPath = Env::get('vendor_path') .'/topthink/think-captcha/assets/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/';
        ...
        Cache::set(self::CACHE_FT_CAPTCHA_PREFIX.$id,$code,$this->expire);
        ...
        return ['id'=>$id,'captcha_base64'=>base64_encode($content)];
    }
